...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 23 18:16:29 2022
...
#
    ...
    fig.tight_layout()
    plt.savefig("results/"+data_title+"_"+e_method+"_out_"+params+".png".format(1))
...
for e_method in methods:
    ...
    with open("results/"+data_title+"_"+e_method+"_out_"+params+".csv", "w") as f:
        w = writer(f)
        w.writerows(csv_dict_out[e_method])
    with open("results/"+data_title+"_"+e_method+"_in_"+params+".csv", "w") as f:
        w = writer(f)
